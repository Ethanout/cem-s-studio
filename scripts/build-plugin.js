...
const sources = ['src/texture-atlas.js', 'src/cem-exporter.js', 'src/blockbench-adapter.js', 'src/entity-database.js', 'src/cemst.js', 'src/reference-rigs.js', 'src/pack-builder.js'];
