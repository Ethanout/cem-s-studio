...
test('registers the CEM-S Studio project format and resource-pack workflow', () => {
  ...
  assert.match(source, /static_atlas/);
  assert.match(source, /host_sampler0/);
  assert.match(source, /animated_sampler0/);
  ...
  assert.match(source, /original_model_mode/);
  assert.match(source, /Original model visibility/);
