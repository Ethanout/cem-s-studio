...
2. Run `npm run build`.
3. In desktop Blockbench, choose **File → Plugins → Load Plugin from File**.
4. Select the generated `plugin.js`.
5. Model with ordinary Blockbench cubes, then choose **File → Export → Export CEM-S 1.21.6 Model**.
